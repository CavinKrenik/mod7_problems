...
TorF = is_palindrome("saippuakivikauppias")
print(TorF)
TorF = is_palindrome("Cavin Krenik")
print(TorF)
'''
...
if age <= 18:
    ...
    if vehicle:
        print(f"Adult with Vehicle: ${fare}")
    else:
        print(f"Adult without Vehicle: ${fare}")
else:  # age >= 65
    if vehicle:
        print(f"Senior with Vehicle: ${fare}")
    else:
        print(f"Senior without Vehicle: ${fare}")
